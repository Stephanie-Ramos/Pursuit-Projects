...
/*
 Built-in functions we have ssen so far include:
 print()
 lowercased()
...
/*
 ...
 print("another statment will be executed if the condition is false")
 }
 */
...
/*
 ...
 SwiftUI tends to use alot of tenary operators
 */
...
case "Skills":
    print("A Line")
    fallthrough //continues to the next case after executing
case "swimming":
...
// Command + A to select all code in the playground
// Control + i to format all code
...
if conditionOne {
 print("A")
    ...
    if conditionTwo { // does not print B when it is true, continues to test conditions
        print("C")
}
print("D")
