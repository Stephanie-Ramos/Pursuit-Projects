...
print(age + 10) //prints 15

let response2 = "twenty seven"
var age2 = Int(response2) ?? 33 // nil-coelescing forgets the response2 value and use 21 instead
print(age2 + 10) // prints 43

let response3 = "27"
if let yourAge = Int(response3) {//optional-binding the response2 value is nil, this functions as the force wrapping. glues the value to the assignment.
